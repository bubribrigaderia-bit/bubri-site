  ...
  return (
    <div className="mx-auto max-w-5xl px-6 py-12 flex flex-col gap-12">
      ...
      <a
        ...
        className="self-center bg-accent text-paper font-bold text-lg md:text-xl px-10 py-5 rounded-full shadow-lg hover:opacity-90 hover:-translate-y-0.5 transition-all"
      >
        {content.cta_final}
      </a>
    </div>
