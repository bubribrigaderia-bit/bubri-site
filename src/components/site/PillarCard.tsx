...
export function PillarCard({ pillar }: { pillar: Pillar }) {
  ...
  const cardClass =
    "group bg-paper-raised rounded-2xl flex flex-col gap-3 p-4 border-2 border-line-soft transition-all hover:-translate-y-1 hover:shadow-lg hover:border-gold";
